...
response.subtitle = T('Computational Core for Plant Metabolomics')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Vikram Pudi <vikram@iiit.ac.in>'
response.meta.description = 'Computational Core for Plant Metabolomics -- A project sanctioned by DBT, Govt. of India'
response.meta.keywords = 'web2py, python, metabolome, metabolomics'
...
response.menu = [
    ...
    (T('Projects'), False, URL('default','list_all_projects'), [])
    ]
